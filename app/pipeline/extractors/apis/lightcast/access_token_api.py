...
import json
import aiohttp
from app.pipeline.common.etls_common import Extractor

class LightCastAccessTokenGenerator(Extractor):
    """LightCast Access Token Generator"""

    async def extract(self, access_token_api, lightcast_grant_type, lightcast_client_id, lightcast_secret, lightcast_scope) -> str:
