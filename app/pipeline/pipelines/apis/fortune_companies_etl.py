...
class FortuneCompaniesETL(Extractor, Transformer, Loader, DataPipeline):
    """Indeed ETL class"""
    def __init__(self, fortune_companies_configs: dict, staging_storage_path: str, production_storage_path: str):
    ...
    def load(self, fortune_companies_df: pd.DataFrame) -> bool:
        ...
        fortune_companies_df.to_csv(self.production_storage_path)
        return True
