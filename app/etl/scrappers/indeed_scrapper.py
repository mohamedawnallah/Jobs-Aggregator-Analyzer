...
from etl.models.job_dataclasses import JobBasicInfo, CompanyBasicInfo, JobCompanyBasicInfo, JobFullInfo, JobMoreInfo, Country
from etl.transformers.indeed_transformer import IndeedBasicJobCompanyInfoTransformer, IndeedJobSkillsTransformer, IndeedMoreJobInfoTransformer, IndeedPagesNoTransformer, IndeedCountriesTransformer


class IndeedScrapper(CountriesScrapper,PagesNoScrapper,JobsCountriesScrapper):
    """Scrapper for Indeed Jobs"""

    def __init__(self, configs: dict, job_specifications: "OrSpecification"):
    ...
    def get_countries(self, countries_no: Optional[int] = None, countries_url: Optional[str] = None) -> Iterator[Country]:
        ...
        print("Countries No: ", countries_number)
    ...
    def get_pages_no(self, country_jobs_url: str) -> int:
        ...
        while True:
            try:
                ...
                logger.warning(attribute_error)
                continue
        return pages_no
    ...
    def get_basic_job_info(
        ...
        for job in jobs_raw_page:
            ...
            company_basic_info: CompanyBasicInfo = CompanyBasicInfo(company_name=company_name,company_location=company_location,company_rating=company_rating,country_name=country_name,company_url="")
            ...
            job_url: str = job_basic_info.job_url
            job_full_info: JobFullInfo = self.get_more_job_info(job_url, company_basic_info, job_basic_info)
            yield job_full_info
    ...
    def get_more_job_info(
        ...
        job_skills = IndeedJobSkillsTransformer.transform(self.job_specifications,job_more_info.job_description)
        
        job_full_info = JobFullInfo(job_skills=job_skills,job_basic_info=job_basic_info,company_basic_info=company_basic_info,job_more_info=job_more_info)
    ...
    @staticmethod
    def get_indeed_job_item_generator(jobs_countries_generator: Iterator[Iterator[Iterator[JobFullInfo]]]) -> Iterator[JobFullInfo]:
    ...
    def get_customized_indeed_country(country_name: str, country_code: str) -> Iterator[Country]:
        ...
        return (Country(country_name=country_name, country_code=country_code) for _ in range(1))